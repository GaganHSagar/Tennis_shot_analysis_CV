...
class HumanPoseExtractor:
    ...
    def __init__(self, shape):
        ...
        # print("metrab loading")
        # self.metrabs = tf.saved_model.load("metrabs") 
        # print("metrabs done")
        self.roi = RoI(shape)
    ...
    def extract(self, frame):
        ...
        # Make predictions
        # code for 3d pose estimation
        # encoded_image = tf.image.encode_jpeg(frame)

        # Decode the JPEG string to obtain the image tensor
        # image = tf.image.decode_jpeg(encoded_image, channels=3)
        # print(image[100])
        # self.pred = self.metrabs.detect_poses(image, skeleton='smpl+head_30')
        # print(self.pred)
        # print(self.pred.shape)
        # code end for 3d pose estimation
